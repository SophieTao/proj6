...
class HomeTest(unittest.TestCase):
	...
	def setUp(self):
		...
		self.driver.get("http://localhost:8004/home/")
...
class OtherPagesTest(unittest.TestCase):
	...
	def test_login(self):
		# Sign up
		self.driver.get("http://localhost:8004/create_account/")
		...
		# Log in
		self.driver.get("http://localhost:8004/login/")
		...
		# Create meals
		self.driver.get("http://localhost:8004/create_listing/")
